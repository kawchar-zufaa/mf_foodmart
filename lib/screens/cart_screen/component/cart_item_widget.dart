...
import 'package:mf_foodmart/screens/cart_screen/component/card_remove_btn.dart';
        ...
        child: Container(
            ...
            child: Row(
              ...
              children: [
                BuildImage(
                  size: size / 10,
                  imgUrl: widget.cartModel.productImage,
                ),
                Expanded(
                  child: Column(
                    ...
                    children: [
                      TextWidget(
                        text: widget.cartModel.productName,
                        maxLines: 2,
                      ),
                ...
                Column(
                  children: [
                    /// Card delete button ------------------------------------
                    CardRemoveBtn(
                        cartController: _cartController, cartModel: widget.cartModel,),
                        ...
                        removeButton: () {
                          if (widget.cartModel.count == 1) {
                            Fluttertoast.showToast(
                                msg: 'You cannot order less than one item');
                          } else {
                            setState(() {
                              _isRemove = true;
                              _isAdd = false;
                            ...
                            CartDatabase.instance
                                .updateCartItem(widget.cartModel);
                          }
                        },
